...
def Setup():
	...
	#Read Registration Data from registration.txt
	# RegFile = open("registration.js", "rb")
	# RegContent=RegFile.read()
	# print ("Registration Data:\n")
	# print RegContent

	# j = json.loads(RegContent) 
	# if j['success'] == True:
	# 	lcd.clear()
	# 	lcd.message("Device already\nRegistored")
	# 	gOut.writerow([("Device already registored")])
	# else:
	# 	SystemRegistration()
	
	#Read Configuration Data from configuration.txt
	# ConfFile = open("configuration.js", "rb")
	# ConfContent=ConfFile.readlines()
	# print ("Configuration Data:\n")
	# print ConfContent
...
def SystemRegistration():
	...
	#Write Registration Data from registration.txt
	WriteFileRegistration(serialnumber,apikey,apisecret)
	
	# serialnumber = j['body']['serialNumber']
	# apikey = j['body']['apiKey']
	# apisecret = j['body']['apiSecret']
	# RegistrationInfo[0] = serialnumber
	# RegistrationInfo[1] = apikey
	# RegistrationInfo[2] = apisecret
	# print "####################################"
	# print RegistrationInfo
	# print "####################################"
	# #Write Registration Data from registration.txt
	# RegFile = open(abs_path+"registration.js","w+")
	# RegFile.write('%s' % RegistrationInfo)
	# RegFile.close()
...
# Try and Exception for Server Timeout 
	...
	try:
		...
		if errstr == "Empty reply from server":
			...
			#giVidCount+=1
			#ImageLoop()	
		# elif errstr == "Empty reply from server" and giFlag == 1:
		# 	lcd.clear()
